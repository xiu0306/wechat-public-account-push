...
const USER_CONFIG = {
  ...
  USERS: [
    {
      ...
      id: 'oRdEm6tOFdtApRZO6VcgbTL0eJXs',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: 'vyPxek1LZ3RqYmnbT1W-3_Dgp6g_1L3Ragi-kHnf9jk',
      // 所在省份
      province: '山东',
      // 所在城市
      city: '济南',
      ...
      festivals: [
        ...
        {
          type: '生日', name: '秀秀', year: '2003', date: '03-06',
        }
      ],
      // 专属纪念日/倒数日，如果你在这里填写了纪念日/倒数日，就不会计算CUSTOMIZED_DATE_LIST的日子了, 和CUSTOMIZED_DATE_LIST的配置方法相同，可以往下查看，我这里就不重复写了
      customizedDateList: [
        // 在一起的日子
        { keyword: 'love_day', date: '2020-01-18' }
      ],
  ...
  CALLBACK_TEMPLATE_ID: 'vyPxek1LZ3RqYmnbT1W-3_Dgp6g_1L3Ragi-kHnf9jk',
  ...
  CALLBACK_USERS: [
    {
      ...
      id: '1	俺爸让我阳光	oRdEm6sKlwFisqeWVWZcSj2nsHYc',
    }
    // 你可以不断按格式往下增加
    // ...
  ],
